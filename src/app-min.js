...
let nextEl=document.querySelector('.next');nextEl.addEventListener('click',function(){pageNumber++;console.log(pageNumber);getPictures()})
let previousEl=document.querySelector('.previous');previousEl.addEventListener('click',function(){pageNumber--;if(pageNumber<=0){pageNumber=1}
    console.log(pageNumber);getPictures()})